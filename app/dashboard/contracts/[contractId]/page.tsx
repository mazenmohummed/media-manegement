...
import { ScheduleStatusChanger } from "@/components/contracts/schedule-status-changer";
        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link href={`/dashboard/contracts/${contract.id}/edit`}>
              <Button variant="outline" className="border-zinc-700 text-zinc-200 hover:bg-zinc-800 h-9 gap-1.5 text-xs">
      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 space-y-4">
        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-zinc-800 pb-3">
          ...
          <div className="flex items-center gap-3">
            <Link
              href={`/dashboard/contracts/${contractId}/recurring-schedules`}
            ...
            <Link href={`/dashboard/contracts/${contractId}/recurring-schedules/new`}>
              <Button size="sm" className="bg-purple-600 hover:bg-purple-500 text-white h-8 gap-1.5 text-xs">
        ...
        {contract.recurringInvoiceSchedules.length > 0 ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {contract.recurringInvoiceSchedules.map((schedule) => (
              <div
                key={schedule.id}
                className="bg-zinc-950/60 p-3 rounded-lg border border-zinc-800/80 text-xs flex flex-col justify-between space-y-3"
              >
