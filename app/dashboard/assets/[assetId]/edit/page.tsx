      ...
      try {
        ...
        if (res.ok) {
          ...
          setFormData({
            ...
            maintenanceDueAt: asset.maintenanceDueAt
              ? new Date(asset.maintenanceDueAt).toISOString().slice(0, 10)
              : "",
          });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setError(error.error || "Failed to update asset");
      }
    } catch (err) {
      console.error(err);
    ...
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 space-y-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-zinc-100">Edit Asset</h1>
            <p className="text-sm text-zinc-500">Update asset details</p>
          </div>
        </div>
